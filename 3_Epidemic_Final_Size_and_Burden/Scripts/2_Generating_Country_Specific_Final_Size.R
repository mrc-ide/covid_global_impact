...
### set to directory
setwd("C:/Users/pgw06/Imperial College London/ncov - Documents/2019-nCoV/LMIC/for_github")

### get WPP demography
demog_WPP<-read.csv("country_inputs.csv")
...
### get severity inputs
severity_inputs<-read.csv("severity_inputs.csv")
severity_inputs
##set R0
R=3.5
...
## three arbitrary example picks
pick_countries<-c("Philippines","South Africa","Russian Federation")

unique(demog_WPP$Country_or_region)
